module Spec.String (containsTest) where
...
containsStringTest = testCase "Testing containsString"
  (assertEqual "return true" True  (String.containsString "apple" "apple-sauce"))

returnStringTest :: TestTree
returnStringTest = testCase "Testing returnString"
  (assertEqual "return :apple-sauce:" ":apple-sauce:"  (String.returnString "apple" "apple-sauce"))
